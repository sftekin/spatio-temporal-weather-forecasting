...
# WEATHER MODEL
model_params["weather_model"]["batch_gen"]["input_dim"] = [0, 7, 8, 13]
model_params["weather_model"]["batch_gen"]["output_dim"] = [0, 7, 8, 13]
model_params["weather_model"]["batch_gen"]["window_in_len"] = 6
model_params["weather_model"]["batch_gen"]["window_out_len"] = 6
...
model_params["weather_model"]["core"]["encoder_params"]["input_dim"] = len(model_params["weather_model"]["batch_gen"]["input_dim"])
...
# CONVLSTM
model_params["convlstm"]["batch_gen"]["input_dim"] = [0, 7, 8, 13]
model_params["convlstm"]["batch_gen"]["output_dim"] = [0, 7, 8, 13]
model_params["convlstm"]["batch_gen"]["window_in_len"] = 6
model_params["convlstm"]["batch_gen"]["window_out_len"] = 6
model_params["convlstm"]["batch_gen"]["batch_size"] = 32
...
model_params["convlstm"]["core"]["encoder_params"]["input_dim"] = 4
model_params["convlstm"]["core"]["encoder_params"]["hidden_dims"] = [4]
model_params["convlstm"]["core"]["decoder_params"]["hidden_dims"] = [3]
model_params["convlstm"]["core"]["decoder_params"]["input_dim"] = 1

# U_NET
model_params["u_net"]["batch_gen"]["input_dim"] = [13]
...
# TRAJ_GRU
model_params["traj_gru"]["batch_gen"]["input_dim"] = [0, 7, 8, 13]
model_params["traj_gru"]["batch_gen"]["output_dim"] = [0, 7, 8, 13]
model_params["traj_gru"]["batch_gen"]["window_in_len"] = 6
model_params["traj_gru"]["batch_gen"]["window_out_len"] = 6
model_params["traj_gru"]["batch_gen"]["batch_size"] = 32
...
model_params["traj_gru"]["core"]["encoder_params"]["input_dim"] = 4
model_params["traj_gru"]["core"]["encoder_params"]["hidden_dim"] = 4
model_params["traj_gru"]["core"]["decoder_params"]["hidden_dim"] = 4
model_params["traj_gru"]["core"]["decoder_params"]["input_dim"] = 4
